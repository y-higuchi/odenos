...
public class SubscriptionsServlet extends HttpServlet {
  ...
  protected void service(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (!matcher.find()) {
      SubscriptionsServlet.logger.debug("The indicated path is not available. /{}", req.getRequestURI());
    ...
    if (session == null) {
      ...
      SubscriptionsServlet.logger.debug("The session is not started yet.");
      resp.setStatus(HttpServletResponse.SC_NOT_FOUND);
      return;
    }
    ...
    if (!session.getId().equals(subscriptionId)) {
      ...
      SubscriptionsServlet.logger.debug("The Subscription ID ({}) is illegal. /Session ID: {}",
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (subscriptionTable == null) {
      SubscriptionsServlet.logger.debug("A Subscription Table is not found. /{}", session.getId());
      resp.setStatus(HttpServletResponse.SC_NOT_FOUND);
      return;
    }
  ...
  protected void doPut(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (reqTable == null) {
      SubscriptionsServlet.logger.debug("Failed to deserialize the request body. /{}", reqBody);
